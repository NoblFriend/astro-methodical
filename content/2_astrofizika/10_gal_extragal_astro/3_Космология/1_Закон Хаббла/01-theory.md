...
Также важно отметить, что судя по всему, Хаббл получал скорости галактик исходя из их красного смещения и использовал для этого эффект Допплера. Однако эффект изменения длины волны происходит из-за расширения вселенной, а не процессов, на которых построен эффект Допплера, поэтому его использование в данном контексте было некорректно. Со временем оказалось, что для небольших расстояний формула зависимости скорости расширения и красного смещения совпадает с Доплеровской (мы это покажем позже), однако это скорее совпадение.