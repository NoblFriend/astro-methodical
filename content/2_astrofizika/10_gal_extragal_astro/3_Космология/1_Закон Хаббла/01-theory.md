...
## 3. Вселенная Фридмана

Нашу Вселенную нужно рассматривать не просто как пространство, а как пространство-время. Например, фотоны, которые мы регистрируем от далёких галактик, летят к нам именно в пространстве-времени. 

![Пространство-время вселенной. Жёлтым обозначен световой конус, то есть множество точек в пространстве времени, куда может дойти свет, излученный источников в то время в том месте. Горизонтальные сечения большого конуса это пространство в фиксированный момент времени](figures/T-S.png)

В $1922$ году Александр Фридман показал, что уравнения ОТО допускают нестационарные космологические решения, в которых Вселенная может расширяться или сжиматься. Позднее эти решения были развиты в рамках модели Фридмана–Леметра–Робертсона–Уокера (FLRW), описывающей однородную и изотропную Вселенную.

Основным геометрическим объектом такой модели является метрика, задающая интервал между событиями в пространстве-времени. Для однородной и изотропной Вселенной она имеет вид

$$
\boxed{
\dd s^2= c^2 \dd t^2 - a^2(t) \dd \Sigma_K^2
}
$$

Здесь $a(t)$ — масштабный фактор, а $\dd \Sigma_K^2$ — пространственная часть метрики Вселенной, определяемая её кривизной K.

По своей структуре эта метрика похожа на метрику Минковского, описывающую плоское пространство-время специальной теории относительности:

$$
\dd s^2= c^2\dd t^2 - \dd x^2+\dd y^2+\dd z^2.
$$

Отличие состоит в том, что в метрике FLRW пространственная часть может быть искривлена, а её масштаб задаётся зависящим от времени фактором $a(t)$. Поэтому метрика Минковского получается как частный случай FLRW при

$$
a(t)=\mathrm{const},\qquad K=0.
$$

Именно применение уравнений Эйнштейна к этой метрике приводит к уравнениям Фридмана, определяющим динамику расширения Вселенной.