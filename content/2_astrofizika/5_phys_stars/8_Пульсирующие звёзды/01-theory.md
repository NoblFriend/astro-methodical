...
T_0
=
\frac{1}{2} \sqrt{\frac{4\pi^2(R/2)^3}{GM}}
=
\sqrt{\frac{\pi^2R^3}{8GM}}
=
\sqrt{\frac{3\pi}{32G\rho}}
$$

Видим, что время свободного падения опять же пропорционально $1/\sqrt{G\rho}$, при этом понятно, что период пульсаций должен в свою очередь быть пропорциональным $T_0$, откуда можно сделать вывод о том, что $T \sim 1/\sqrt{G\rho}$.
