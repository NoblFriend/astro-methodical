...
::: {.formula-box caption="Уравнение связи доли газового давления и массы звезды"}
$$
\frac{\beta^4}{1-\beta}
\approx
...
![Доля давления излучения в центре звезды в зависимости от $\lg(\mu^2 M)$](figures/beta-mass-figure)
...
::: {.formula-box caption="Предел Эддингтона"}
$$
L_{\rm Edd}
=
