## 4.1. Описание модели и сравнение с реальностью
...
2. Отдельно отметим, что для звёзд Г.П. с массой больше солнечной как правило очень неплохо подходит политропа с $n = 3$. Этот случай будет для нас далее достаточно важен.
...
Итого, уравнение Лэйна-Эмдена в безразмерной форме:
...
## 4.3. Стандартная модель Эддингтона
...
Итак, мы доказали что стандартная модель Эддингтона по сути своей является политропой с $n = 3$ (и обратно, в политропа с $n = 3$ эквивалентна стандартной модели).
