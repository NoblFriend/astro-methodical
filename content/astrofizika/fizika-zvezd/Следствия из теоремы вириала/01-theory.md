...
$$
\boxed{U=-\omega\frac{GM^2}{R}, \qquad \omega=\int_0^1\frac{q\,dq}{x}}
$$
...
![Зависимость параметра](img/omega.png)
...
![Зависимость параметра p](img/p.png)
...
![Зависимость центральной температуры](img/T.png)
